...
IMAGE_IDS = 10000 + [5:5:50]; %[170, 98, 234,289,299,27,77,];%298,299,306];
...
imwrite(final_image_alexnet, [FIGS_PATH, 'fig_splash_alexnet.png']);
imwrite(final_image_vgg16, [FIGS_PATH, 'fig_splash_vgg16.png']);
